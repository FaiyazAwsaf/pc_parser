<template>
  <div class="min-h-screen bg-gray-50 pb-10">
    <!-- Gradient Header -->
    <div class="bg-gradient-to-br from-slate-900 to-blue-800 text-white py-10 text-center rounded-b-xl shadow mb-8">
      <h1 class="text-3xl md:text-4xl font-extrabold">Sell Your Product</h1>
    </div>

    <div class="max-w-4xl mx-auto bg-white py-10 px-6 rounded-lg shadow">
      <!-- Select Product Type -->
      <div class="mb-6">
